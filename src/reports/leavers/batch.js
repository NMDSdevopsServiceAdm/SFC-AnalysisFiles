...
const findLeaversByBatch = (batchNum) =>
  db
    ...
    SELECT 'M' || DATE_PART('year',(b."RunDate" - INTERVAL '1 day')) || LPAD(DATE_PART('month',(b."RunDate" - INTERVAL '1 day'))::TEXT,2,'0') period,
       ...
       EXTRACT(YEAR FROM AGE((SELECT MAX("When") FROM "WorkerAudit" WHERE "EventType" = 'deleted' AND "WorkerFK" =  w."ID" LIMIT 1), pgp_pub_decrypt("DateOfBirthEncryptedValue" :: bytea, dearmor(convert_from(decode(:private,'base64'),'UTF8'))) :: DATE)) age,
